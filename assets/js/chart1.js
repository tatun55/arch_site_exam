...
setTimeout(function () {
    $('#price-dummy').hide();
    $('#total-price').fadeIn(3000);
    $('#off-amount').fadeIn(3000);
}, time_interval * i);
i++;
        // setTimeout(function () {
        //     chart.load({
        //         columns: [['販売会社 経費・利益', 36, 34, 15]]
        //     });
        // }, time_interval);
        // setTimeout(function () {
        //     chart.groups([['工場品出し価格', '販売会社 経費・利益']])
        ...
        // setTimeout(function () {
        //     chart.load({
        //         columns: [['国内代理店 経費・利益', 25, 26]]
        //     });
        // }, time_interval * 3);
        // setTimeout(function () {
        //     chart.groups([['工場品出し価格', '販売会社 経費・利益', '国内代理店 経費・利益']])
        // }, time_interval * 4);
        // setTimeout(function () {
        //     chart.load({
        //         columns: [['大手商社店 経費・利益', 24, 25]]
        //     });
        // }, time_interval * 5);
        // setTimeout(function () {
        //     chart.groups([['工場品出し価格', '販売会社 経費・利益', '国内代理店 経費・利益', '大手商社店 経費・利益']])
        // }, time_interval * 6);